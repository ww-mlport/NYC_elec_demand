---
title: "NYC Electricity Demand Prediction - EDA and Data Tidying"
...
* Tasks:
    ...
    2. Filter for only 2016 - 2019 (excl. COVID impacts)
    3. Manage NAs/blank cells
    4. Outlier detection
    5. Add lagged demand variable
    6. Add categorical variables (weekday/weekend & seasons)
...
* Weak linear relationships between numerical variables; ANOVA of categorical variables (weekday/weekend and seasons) suggest a statistically significant relationship with MWh
